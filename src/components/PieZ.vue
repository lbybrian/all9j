...
//		  				this.ruleForm.yAxis=item.aggName
...
////		  		}
//
//      	console.log('饼状图2222222222',this.ruleForm,this.obj)
//  },
    methods: {
      // 保存配置图表
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
        	...
        	console.log('饼状图axisYArr',this.ruleForm.axisYArr)

<template>
  <div class="instantAudit" v-loading="loading">
    ...
    <el-table v-loading="loading2" v-if="tableData.length>0" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.5)" ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%">
      ...
      <el-table-column prop="moduleSign" label="模块名称" width="240">
    ...
    <el-dialog v-if="checkVisible" :visible.sync="checkVisible" top="2vh" width="80%">
      ...
      <log-detail v-show="checkVisible" :detail="logDetail"></log-detail>
...
//        console.log('this.obj.id更新',this.obj.id)
...
//      immediate:true,
    ...
    created() {
      if (this.objId) {
//    	console.log("Instanttttttttttt+objId")
        this.params.ruleId = this.objId
        this.getList(this.currentPage2, this.pageSize2, this.params)
      }else if(this.obj){
//    	console.log("Instanttttttttttt+objId")
      	this.params.ruleId=this.obj
      	this.getList(this.currentPage2, this.pageSize2, this.params)
      }else{
      	this.params={
				    "pageNum":1,
      ...
      this.getList(this.currentPage2, this.pageSize2, this.params)
      if (this.obj!==null) {
      	console.log("详情创建了，obj来了",this.obj.id,this.objId)
    ...
    methods: {
      ...
      ecportFun() {
        ...
        let url = API + '/exportLogData/exportCycleStatResultData?id=' + this.obj.id
        location.href = url
      },
      getList(page, pageSize, params) {
        ...
        let url = '/analyzeRule/getAnalyzeResultRecordDataDetail'//jk9
...
//          console.log('图表数据',this.chartList)
            setTimeout(() => {
